...
<div class="container my-4">
    <h4>View check-in records</h4>
    <%-- Loop through checkIns records--%>
    <% for (int i = 1; i <= 3; i++) { %>
    <div class="card mb-3">
            <div class="row g-0 align-items-center">
              <div class="col-md-8">
                <div class="card-body">
                    ...
                    <p class="card-text"><b>Check-in Date:</b> 2024-4-22</p>
                    <p class="card-text"><b>Item:</b> Laptop<%= i %></p>
                    <p class="card-text"><b>Campus:</b> LWL<%= i %></p>
                    <button type="button" class="btn btn-primary">Confirm</button>
                    <button type="button" class="btn btn-danger">Report Damage</button>
